...
describe('Api1Component', () => {
  ...
  describe('Permission Signal Values', () => {
    ...
    it('should use correct resource name for permission signals', () => {
      ...
      expect(calls.every(call => call.args[0] === 'API1')).toBe(true);
    });
  });
  ...
  describe('Component Integration', () => {
    ...
    it('should use correct resource name for permission checking', () => {
      ...
      expect(createCall?.args[0]).toBe('API1');
      expect(updateCall?.args[0]).toBe('API1');
      expect(deleteCall?.args[0]).toBe('API1');
    });
  });
  ...
  describe('Error Handling', () => {
    it('should handle permissions service errors gracefully', () => {
      ...
      expect(() => {
        TestBed.createComponent(Api1Component);
      }).toThrow();
    });
  });
});
