...
describe('Api7Component', () => {
  ...
  describe('Component Creation', () => {
    ...
    it('should initialize with correct RESOURCE_NAME', () => {
      expect(component.RESOURCE_NAME).toBe('API7');
    });
  ...
  describe('Permission Signals Initialization', () => {
    it('should create permission signals for CREATE, UPDATE, and DELETE', () => {
      expect(mockPermissionsService.createResourcePermissionSignal).toHaveBeenCalledWith('API7', Permission.CREATE);
      expect(mockPermissionsService.createResourcePermissionSignal).toHaveBeenCalledWith('API7', Permission.UPDATE);
      expect(mockPermissionsService.createResourcePermissionSignal).toHaveBeenCalledWith('API7', Permission.DELETE);
  ...
  describe('Permission Signal Values', () => {
    ...
    it('should use correct resource name for permission signals', () => {
      ...
      expect(calls.every(call => call.args[0] === 'API7')).toBe(true);
    });
  });
  ...
  describe('Component Integration', () => {
    ...
    it('should use correct resource name for permission checking', () => {
      ...
      expect(createCall?.args[0]).toBe('API7');
      expect(updateCall?.args[0]).toBe('API7');
      expect(deleteCall?.args[0]).toBe('API7');
    });
  });
  ...
  describe('Error Handling', () => {
    it('should handle permissions service errors gracefully', () => {
      ...
      expect(() => {
        TestBed.createComponent(Api7Component);
      }).toThrow();
    });
  });
});
