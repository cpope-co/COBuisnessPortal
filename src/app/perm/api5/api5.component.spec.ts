...
describe('Api5Component', () => {
  ...
  describe('Component Creation', () => {
    ...
    it('should initialize with RESOURCE_NAME (note: currently using API2)', () => {
      // NOTE: This component has a bug - it uses 'API2' instead of 'API5'
  ...
  describe('Error Handling', () => {
    it('should handle permissions service errors gracefully', () => {
      ...
      expect(() => {
        TestBed.createComponent(Api5Component);
      }).toThrow();
    });
  });
  ...
  describe('Bug Documentation', () => {
    it('should document the RESOURCE_NAME bug for future fixing', () => {
      // This test documents the bug where Api5Component uses 'API2' instead of 'API5'
      // When this bug is fixed, this test should be updated to expect 'API5'
      expect(component.RESOURCE_NAME).toBe('API2'); // Should be 'API5'
    });
  });
});
